...
I focus on learning deeply and building intentionally.  
I prefer fewer well-crafted projects over many shallow ones.  
I enjoy building things slowly and correctly.

---

## GitHub Profile
https://github.com/Venkateshx7
...
## Current Focus
- Building ProGuin for (CLI , Android & web )
...
- Using the same Python logic used for CLI - (using Chaquopy to embed the logic to android using Kotlin)
...
- Successfully reviewed and merged first external contribution
- Actively managing issues, labels, and pull requests
